    ...
    <jsp:attribute name="content">
        <form method="post" class="stacked">
            ...
            <div class="column margin">
                ...
                <input type="text" name="name" value="${kategorien_form.values["name"][0]}">
            ...
            <%-- Fehlermeldungen --%>
            <c:if test="${!empty kategorien_form.errors}">
                <ul class="errors margin">
                    <c:forEach items="${kategorien_form.errors}" var="error">
                        <li>${error}</li>
                        </c:forEach>
                </ul>
            </c:if>
                    ...
                    <div>
                        <div class="margin">
                            <c:forEach items="${kategorien}" var="kategorie">
                                <input type="checkbox" name="kategorie" id="${'kategorie-'.concat(kategorie.slug)}" value="${kategorie.slug}" />
                                <label for="${'kategorie-'.concat(kategorie.slug)}">
